...
passed. The native amd64 candidate scan no longer reports one server-binary
Thrift finding, but still reports eight signed-plugin HIGH findings; the active
Grafana image has nine HIGH findings. Arm64 candidate validation and the
